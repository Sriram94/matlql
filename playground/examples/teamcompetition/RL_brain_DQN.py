...
class DeepQNetwork:
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('DQNValue', reuse = tf.AUTO_REUSE):
            self.name_scope = tf.get_variable_scope().name
            with tf.variable_scope('eval_net_1', reuse = tf.AUTO_REUSE):
                ...
                with tf.variable_scope('l_h1', reuse = tf.AUTO_REUSE): 
