...
def main():
    ...
    agent_list = [
        agents.matwolevelacAgent_insufficient_differentquality(201, sess),
    ...
    with open('matlacvsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2}\n'.format("Episode", "Reward1(MATLAC)","Reward2(DQN)"))

    with open('expertfrequencymatlac.csv', 'w+') as myfile:
