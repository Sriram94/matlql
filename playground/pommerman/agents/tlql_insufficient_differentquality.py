...
class twolevelqlAgent_insufficient_differentquality(BaseAgent):
    def __init__(self, nf, sess, *args, **kwargs):
        super(twolevelqlAgent_insufficient_differentquality, self).__init__(*args, **kwargs)
        self._recently_visited_positions = []
        self._recently_visited_length = 6
        self._prev_direction = None
        self.RL = tlqlNetwork(sess, 6, nf, 4,
                      learning_rate=0.01,
                      reward_decay=0.9,
                      e_greedy=0.9,
