...
def main():
    ...
    agent_list = [
        agents.DQNAgent_differentagents('pommerman1', 372, sess),
        agents.DQNAgent_differentagents('pommerman2', 372, sess),
        agents.DQNAgent_differentagents('pommerman1', 372, sess),
        agents.DQNAgent_differentagents('pommerman2', 372, sess),
    ]
    ...
    with open('dqnvsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(DQN)", "Reward2(DQN)", "Reward1(DQN)", "Reward2(DQN)"))
    ...
    for i_episode in range(50000):
        ...
        with open('dqnvsdqn.csv', 'a') as myfile:
