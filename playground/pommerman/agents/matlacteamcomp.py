...
from RL_brain_matwolevelacteamcomp import Actor
from RL_brain_matwolevelacteamcomp import Critic
from RL_brain_matwolevelacteamcomp import Actor2
from RL_brain_matwolevelacteamcomp import Critic2
...
class matwolevelacteamAgent(BaseAgent):
    def __init__(self, n_f, sess, *args, **kwargs):
        super(matwolevelacteamAgent, self).__init__(*args, **kwargs)
    ...
    def act(self, obs, action_space):       
        ...
        if (np.random.uniform() <= self.eps):
            ...
            self.frequency[s] = self.frequency[s] + 1    
            return a
