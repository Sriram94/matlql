...
def main():
    ...
    agent_list = [
        agents.Advisor2_differentquality(),
    ...
    with open('Advisor2vsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(Advisor2)", "Reward2(DQN)", "Reward1(Advisor2)", "Reward2(DQN)"))
    ...
    for i_episode in range(50000):
        ...
        with open('Advisor2vsdqn.csv', 'a') as myfile:
