...
def main():
    ...
    with open('dqfdvsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(DQfD)","Reward2(DQN)", "Reward1(DQfD)", "Reward2(DQN)"))
    ...
    for i_episode in range(50000):
        ...
        while not done:
            ...
            agent_list[3].run_DQfD(state[3], actions[3], reward[3], state_new[3], done)
        ...
        with open('dqfdvsdqn.csv', 'a') as myfile:
            myfile.write('{0},{1},{2},{3},{4}\n'.format(i_episode, cumulative_rewards[1], cumulative_rewards[0], cumulative_rewards[3], cumulative_rewards[2]))
