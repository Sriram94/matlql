...
def main():
    ...
    agent_list = [
        agents.matwolevelacteamAgent(372, sess),
    ...
    with open('matlacvsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(MATLAC)", "Reward2(DQN)", "Reward1(MATLAC)", "Reward2(DQN)"))
            
    with open('expertfrequencymatlac.csv', 'a') as myfile:
    ...
    for i_episode in range(50000):
        ...
        while not done:
            ...
            agent_list[0].learn(state[0], actions[0], action_list, reward[0], state_new[0], action_list_new, done)
            agent_list[2].learn(state[2], actions[2], action_list2, reward[2], state_new[2], action_list_new2, done) 
            state = state_new
            actions = actions_new
        agent_list[1].learn()
        agent_list[3].learn()
        ...
        with open('matlacvsdqn.csv', 'a') as myfile:
