...
def main():
    ...
    with open('admiralvsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(ADMIRAL)", "Reward2(DQN)", "Reward1(ADMIRAL)", "Reward2(DQN)"))

    
    with open('expertfrequencyadmiral.csv', 'a') as myfile:
    ...
    for i_episode in range(50000):
        ...
        while not done:
            ...
            action_list2.append(actions[3])
            
            action_list_new = []
            action_list_new2 = []

            action_list_new.append(actions_new[1])
            ...
            action_list_new2.append(actions_new[3])
            agent_list[0].store(state[0], actions[0], action_list, action_list_new, reward[0], state_new[0], actions_new[0])
            agent_list[2].store(state[2], actions[2], action_list2, action_list_new2, reward[2], state_new[2], actions_new[2])
            agent_list[0].set(action_list_new)
            agent_list[2].set(action_list_new2)
            state = state_new
            actions = actions_new
        agent_list[0].learn()
        agent_list[1].learn()
        ...
        with open('admiralvsdqn.csv', 'a') as myfile:
