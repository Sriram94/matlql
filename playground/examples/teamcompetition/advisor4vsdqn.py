...
def main():
    ...
    agent_list = [
        agents.Advisor4_differentquality(),
    ...
    with open('Advisor4vsdqn.csv', 'w+') as myfile:
        myfile.write('{0},{1},{2},{3},{4}\n'.format("Episode", "Reward1(Advisor4)", "Reward2(DQN)", "Reward1(Advisor4)", "Reward2(DQN)"))
    ...
    for i_episode in range(50000):
        ...
        with open('Advisor4vsdqn.csv', 'a') as myfile:
