...
class tlqlNetworkJA:
    ...
    def _build_net(self):
        self.s = tf.placeholder(tf.float32, [None, self.n_features+1], name='tlql_s1')  
        ...
        with tf.variable_scope('tlql_Value'):
            ...
            with tf.variable_scope('tlql_eval_net_1'):
                ...
                with tf.variable_scope('tlql_l_1'):
                    w1 = tf.get_variable('tlql_w_1', [self.n_features+1, n_l1], initializer=w_initializer, collections=c_names)
            ...
            self.s_ = tf.placeholder(tf.float32, [None, self.n_features+1], name='tlql_s1')    
        ...
        with tf.variable_scope('tlql_Advisor'):
            ...
            with tf.variable_scope('tlql_advisor_net_1'):
                ...
                with tf.variable_scope('tlql_l'):
                    w1 = tf.get_variable('w', [self.n_features+1, n_l1], initializer=w_initializer, collections=c_names)
    ...
    def choose_advisor(self, observation, a2, execution=False):
    ...
    def learn(self):
        ...
        e = batch_memory[:, self.n_features+3].astype(int)
