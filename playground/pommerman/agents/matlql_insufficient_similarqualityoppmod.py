...
class matwolevelqlAgent_insufficient_similarqualityoppmod(BaseAgent):
    def __init__(self, nf, sess, *args, **kwargs):
        super(matwolevelqlAgent_insufficient_similarqualityoppmod, self).__init__(*args, **kwargs)
