...
class admiraldm_insufficient_differentquality(BaseAgent):
    def __init__(self, nf, sess, *args, **kwargs):
        super(admiraldm_insufficient_differentquality, self).__init__(*args, **kwargs)
    ...
    def act(self, obs, action_space):
        if (np.random.uniform() <= self.eps):
            ...
            list_action = [0] * self.totalactions
            new_action_list = []
            for i in range(self.totalactions):
                if i == a1:
